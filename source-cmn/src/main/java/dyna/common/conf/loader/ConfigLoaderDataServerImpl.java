 ...
 * 读取数据服务配置
 * 
 * @see dyna.common.conf.ConfigurableDataServerImpl
 * @author Wanglei
 * 
 */
public class ConfigLoaderDataServerImpl extends AbstractConfigLoader<ConfigurableDataServerImpl>
{
	 ...
	 */
	@Override
	public synchronized ConfigurableDataServerImpl load(String xmlFilePath)
	{
		if (this.dsConfig == null)
		{
			...
			this.dsConfig = new ConfigurableDataServerImpl();
	 ...
	 */
	@Override
	public ConfigurableDataServerImpl load()
	{
