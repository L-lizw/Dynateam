...
public class TIPTOPServiceGateWayLocator extends org.apache.axis.client.Service implements dyna.app.service.brs.erpi.t100IntegrateService.TIPTOPServiceGateWay {
    ...
    private java.lang.String TIPTOPServiceGateWayPortType_address = "http://10.40.40.18/wt10dev/ws/r/awsp900";
    ...
    public dyna.app.service.brs.erpi.t100IntegrateService.TIPTOPServiceGateWayPortType getTIPTOPServiceGateWayPortType() throws javax.xml.rpc.ServiceException {
    ...
    public dyna.app.service.brs.erpi.t100IntegrateService.TIPTOPServiceGateWayPortType getTIPTOPServiceGateWayPortType(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            dyna.app.service.brs.erpi.t100IntegrateService.TIPTOPServiceGateWayBindingStub _stub = new dyna.app.service.brs.erpi.t100IntegrateService.TIPTOPServiceGateWayBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (dyna.app.service.brs.erpi.t100IntegrateService.TIPTOPServiceGateWayPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                dyna.app.service.brs.erpi.t100IntegrateService.TIPTOPServiceGateWayBindingStub _stub = new dyna.app.service.brs.erpi.t100IntegrateService.TIPTOPServiceGateWayBindingStub(new java.net.URL(TIPTOPServiceGateWayPortType_address), this);
                _stub.setPortName(getTIPTOPServiceGateWayPortTypeWSDDServiceName());
                return _stub;
            }
        }
